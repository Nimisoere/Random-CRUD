...
const CustPag = props => {
  const { itemsCount, itemsToShow, pageOfItems, onChangePage } = props;
        ...
        <Pagination className="pagination">
          ...
          >
            <PaginationLink
              ...
              onClick={() => setPage(1)}
            >
              <MdChevronLeft className="pagination__link-icon" />
            </PaginationLink>
          </PaginationItem>
          {pages.map(page => (
            <PaginationItem
          ...
          >
            ...
            >
              <MdChevronRight className="pagination__link-icon" />
            </PaginationLink>
          </PaginationItem>
        </Pagination>
      )}
